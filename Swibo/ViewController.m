...
//	}
    ...
    aX = self.motionManager.accelerometerData.acceleration.x;
    aY = self.motionManager.accelerometerData.acceleration.y;
    aZ = self.motionManager.accelerometerData.acceleration.z;
    
    NSString *test = [NSString stringWithFormat:@"%+.6f   ,   %+.6f",aX,aY];
